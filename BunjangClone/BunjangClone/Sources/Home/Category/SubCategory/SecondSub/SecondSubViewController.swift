//
//  SecondSubCategoryViewController.swift
//  BunjangClone
//
...
class SecondSubCategoryViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        showIndicator()
        SubCategoryDataManager().getSecondSubCategory(id: currentId, subId: category.id, clicked: 0, viewController: self)
        ProductDataManager().getSecondSubCategory(id: currentId, subId: category.id, page: 1, viewController: self)
...
extension SecondSubCategoryViewController: UICollectionViewDelegate,
    ...
    @objc func buttonPressed(_ sender: UIButton) {
        ...
        if isExpand {
            ...
            SubCategoryDataManager().getSecondSubCategory(id: currentId, subId: category.id, clicked: 1, viewController: self)
        } else {
